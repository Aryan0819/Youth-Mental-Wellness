...
<h1 align="center">🧠 MindMate AI | AI-Powered Emotional Companion</h1>
...
- **Language**: **Python**.
- **Architecture**: Logic is self-contained in a single `app.py` file, simplifying deployment.
...
**1. Prerequisites**
- Python 3.8 or newer.
- A **Groq API Key** (get one for free from [GroqCloud](https://console.groq.com/)).

**2. Installation**
```bash
# Clone the repository
git clone [https://github.com/Aryan0819/Youth-Mental-Wellness.git](https://github.com/Aryan0819/Youth-Mental-Wellness.git)
